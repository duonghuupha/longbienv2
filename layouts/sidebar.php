    ...
    <ul class="nav nav-list">
        ...
        <li class="hover">
            <a href="#" class="dropdown-toggle">
                ...
                <span class="menu-text"> Chuyên môn </span>
                <b class="arrow fa fa-angle-down"></b>
            </a>
            <b class="arrow"></b>
            <ul class="submenu">
        ...
        <li class="hover">
            <a href="#" class="dropdown-toggle">
                ...
                <span class="menu-text"> Kiểm định CL </span>
                <b class="arrow fa fa-angle-down"></b>
            </a>
            <b class="arrow"></b>
            <ul class="submenu">
        ...
        <li class="hover">
            <a href="#" class="dropdown-toggle">
                ...
                <span class="menu-text"> Hồ sơ công việc </span>
                <b class="arrow fa fa-angle-down"></b>
            </a>
            <b class="arrow"></b>
            <ul class="submenu">
        ...
        <li class="hover">
            <a href="#" class="dropdown-toggle">
                ...
                <span class="menu-text"> Trang thiết bị </span>
                <b class="arrow fa fa-angle-down"></b>
            </a>
            <b class="arrow"></b>
            <ul class="submenu">
